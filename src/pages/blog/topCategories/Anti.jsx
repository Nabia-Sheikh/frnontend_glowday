...
import antiWrinkle from "../../../data/anti.json"
...
const Anti = () => {
  ...
  return (
    <section className="padding-top-4 padding-bottom-4 null">
      <div className="container padding-left__l-1 padding-right__l-1 padding-left__d-0 padding-right__d-0">
        ...
        <div className="column text-center margin-bottom-2 margin-top-1">
          <Link
            className="button text-center button--outline"
            to="/blog/categories/anti-wrinkle-treatments"
          >
            More great articles
          </Link>
        </div>
