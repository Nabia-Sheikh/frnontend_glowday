  ...
  return (
    <section className="section section__charcoal">
      <div className="container">
        <div className="column padding-left__l-4 padding-left__d-3">
          <div className="title title--smaller">
            <h2>Discover Treatment Guides</h2>
            <span>Get the glow down on your favourite treatment</span>
          </div>
        </div>
      </div>
      <div className="margin-left__l-2 margin-right__l-2">
        <div className="container">
