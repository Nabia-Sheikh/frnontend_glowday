  ...
  return (
    <div
      className={`fresnel-container ${
        isMobile ? "fresnel-lessThan-md" : "fresnel-greaterThanOrEqual-md"
      }`}
    >
      <div className="homepage-search column--relative">
        <div className="row">
          ...
          <form
            ...
            className="search-widget__form column--relative"
          >
            {current === "treatment" ? (
              <>
                <div className="column-t-5">
                  <div className="field result_dropdown field--search">
                    <label className="sr-only" htmlFor="search_by_treatment">
                      Treatment
                    </label>
                    <div className="field">
                ...
                <div className="column-t-5">
                  <div className="field result_dropdown">
                    <div className="column-m-12">
                      <label className="sr-only" htmlFor="search_by_location">
                        Location
                      </label>
                      <div className="field">
                        <div className="column-m-12 ">
              ...
              <div className="field">
                <div className="column-m-12 column--relative">
                  <label className="sr-only" htmlFor="sticky_search_for_clinic">
                    Clinic
                  </label>
                  <input
                    type="input"
                        ...
                        >
                          {clinicsList &&
                            ...
                            clinicsList.map((clinic) => (
                              <div className="search-widget__results">
                                <Link to={`/clinic/${clinic.clinicData.slug}`}>
                                  <div className="radio-result">
                                    <input
                                      type="radio"
                                      id={clinic._id}
                                    ...
                                    <div className="radio-result__wrapper">
                                      ...
                                      <div className="results--clinic">
                                        <label htmlFor={clinic.clinicData.name}>
