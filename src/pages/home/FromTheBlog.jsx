...
const FromTheBlog = () => {
  ...
  return (
    <section className="section section__charcoal">
      <div className="column text-center margin-bottom-3">
        <span className="uppercase golden--light bold">From the blog</span>
      ...
      <div className="row content-center">
        <div className="column column-t-5 column-d-4 column-lg-3 text-center margin-top__l-2">
          <Link
            className="button text-center button--fullwidth button--outline--white"
            to="/blog"
          >
            More great articles
          </Link>
