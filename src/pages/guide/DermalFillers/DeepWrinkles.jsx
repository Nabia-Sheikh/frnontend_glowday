      ...
      <div className="margin-top-1">
            ...
            <div className="row">
              <div className="column">
                <ul>
                  ...
                  <li className="active">
                    <a href>Deep Wrinkles and Scars </a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="banner banner__background-slant--golden-light">
          ...
          <div className="banner__content text-center">
            <div className="container">
              <div className="column">
                <h1 className="text-left">Deep Wrinkles and Scars</h1>
          ...
          <div className="container top-questions">
            ...
            <div className="row">
              <div className="column-t-6 column question top-questions__border">
                <a href="#filling-deep-wrinkles-and-scars-overview">
                  Fillers for Wrinkles and Scars - Overview
                </a>
              </div>
              <div className="column-t-6 column question top-questions__right">
                <a href="#how-does-dermal-filler-for-deep-static-lines-work">
                  How does dermal filler for deep, static lines work?
                </a>
              </div>
              <div className="column-t-6 column question top-questions__border">
                <a href="#who-is-suitable-for-wrinkle-filler-treatment">
                  Who is suitable for wrinkle filler treatment?
                </a>
              </div>
              <div className="column-t-6 column question top-questions__right">
                <a href="#how-should-i-prepare-for-a-wrinkle-filler-treatment">
                  How should I prepare for a wrinkle filler treatment?
                </a>
              </div>
              <div className="column-t-6 column question top-questions__border">
                <a href="#your-wrinkle-filler-treatment">
                  Your wrinkle filler treatment
                </a>
              </div>
              <div className="column-t-6 column question top-questions__right">
                <a href="#what-happens-after-a-wrinkle-filler-treatment">
                  What happens after a wrinkle filler treatment?
                </a>
              </div>
              <div className="column-t-6 column question top-questions__border">
                <a href="#what-are-the-side-effects-and-risks-of-wrinkle-filler-treatments">
                  What are the side effects and risks of wrinkle filler
                  treatments?
                </a>
              </div>
              <div className="column-t-6 column question top-questions__right">
                <a href="#how-much-do-wrinkle-filler-treatments-cost">
        ...
        <section className="padding-top-4 padding-bottom-4">
          <div className="container">
            <div className="row">
              <div
                data-name="filling-deep-wrinkles-and-scars-overview"
                id="filling-deep-wrinkles-and-scars-overview"
                className="column null"
              >
                <div className="row">
                  <div className="column column-t-4">
                    <h2>Filling deep wrinkles and scars - Overview</h2>
                  </div>
                  <div className="cms-content column column-t-8">
                    <div className="cms-content undefined">
                      <p>
                        As the skin ages, it gradually loses some of its
                        <a href="../../../blog/collagen-the-protein-that-keeps-us-looking-young/">
                          collagen
                        </a>
                        along with the fat lying underneath. These are the
                        materials that prevent the skin from becoming
                        <a href="../../../blog/saggy-skin-we-have-lift-off/">
                          saggy
                        </a>
                        . Thus, as we age, our skin can become thinner and more
                        wrinkled and lined, losing volume and fullness.
                      </p>
                      <p>
                        Some wrinkles need more than just Botox®. These are the
                        static wrinkles which are present, even when the face is
                        at rest. Strategically placed threads of fillers help to
                        fill deep wrinkles, and also scars, thus restoring a
        ...
        <section className="padding-top-4 padding-bottom-4 section__charcoal">
          <div className="container">
            <div className="row">
              <div
                data-name="how-does-dermal-filler-for-deep-static-lines-work"
                id="how-does-dermal-filler-for-deep-static-lines-work"
                className="column null"
              >
                <div className="row">
                  <div className="column column-t-4">
                    <h2>How does dermal filler for deep, static lines work?</h2>
                  </div>
                  <div className="cms-content column column-t-8">
                    <div className="cms-content undefined">
                      <p>
                      ...
                      <p>
                        When injected into the skin, the filler plumps out
                        wrinkles and lines, instantly filling out wrinkles,
                        scars and adding volume and shape where necessary.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="padding-top-4 padding-bottom-4">
          <div className="container">
            <div className="row">
              <div
                data-name="who-is-suitable-for-wrinkle-filler-treatment"
                id="who-is-suitable-for-wrinkle-filler-treatment"
                className="column null"
              >
                <div className="row">
                  <div className="column column-t-4">
                    <h2>Who is suitable for wrinkle filler treatment?</h2>
                  </div>
                  <div className="cms-content column column-t-8">
                    <div className="cms-content undefined">
                      <p>
                        Dermal fillers can be used to help reduce the appearance
                        of static lines and wrinkles on the face, neck,
                        décolletage and hands. They are used to:
                      </p>
                      <p />
                      <ul>
                        <li>
                          Fill static, deep lines around the lips, the lines
                          from the nose to the corners of the mouth (nasolabial
                          lines), smile lines, marionette lines and crow’s feet
                        </li>
                        <li>
        ...
        <section className="padding-top-4 padding-bottom-4 section__charcoal">
          <div className="container">
            <div className="row">
              <div
                data-name="how-should-i-prepare-for-a-wrinkle-filler-treatment"
                id="how-should-i-prepare-for-a-wrinkle-filler-treatment"
                className="column null"
              >
                <div className="row">
                  <div className="column column-t-4">
        ...
        <section className="padding-top-4 padding-bottom-4">
          <div
            data-name="your-wrinkle-filler-treatment"
            id="your-wrinkle-filler-treatment"
          >
            <div className="container">
              <div className="row">
                <div className="column">
                  <h2>Your wrinkle filler treatment</h2>
                </div>
              </div>
              <div className="row">
        ...
        <section className="padding-top-4 padding-bottom-4 section__charcoal">
          <div className="container">
            <div className="row">
              <div
                data-name="what-happens-after-a-wrinkle-filler-treatment"
                id="what-happens-after-a-wrinkle-filler-treatment"
                className="column null"
              >
                <div className="row">
                  <div className="column column-t-4">
                    <h2>What happens after a wrinkle filler treatment?</h2>
                  </div>
                  <div className="cms-content column column-t-8">
                    <div className="cms-content undefined">
                      <p>
        ...
        <section className="padding-top-4 padding-bottom-4">
          <div className="container">
            <div className="row">
              <div
                data-name="what-are-the-side-effects-and-risks-of-wrinkle-filler-treatments"
                id="what-are-the-side-effects-and-risks-of-wrinkle-filler-treatments"
                className="column null"
              >
                <div className="row">
                  <div className="column column-t-4">
        ...
        <section className="padding-top-4 padding-bottom-4 section__charcoal">
          <div className="container">
            <div className="row">
              <div
                data-name="how-much-do-wrinkle-filler-treatments-cost"
                id="how-much-do-wrinkle-filler-treatments-cost"
                className="column null"
              >
                <div className="row">
                  <div className="column column-t-4">
                    <h2>How much do wrinkle filler treatments cost?</h2>
                  </div>
                  <div className="cms-content column column-t-8">
                    <div className="cms-content undefined">
                      <p>
