      ...
      <div className="fresnel-container fresnel-greaterThanOrEqual-md ">
        <div className="container--wide">
          <div className="steps--container">
            <ul className="steps">
              <li className="icon icon--complete icon--upcoming">
                <Link to="/client">
          ...
          <div className="row">
            <div className="column">
              <div className="border-bottom-t margin-bottom-2 boldest">
                ...
                <p>
                  You can view and manage your upcoming bookings, book your
                  sessions and confirm appointment set up by your practitioners.
                </p>
              </div>
              <div className="container client-booking-list-container">
                ...
                <h2 className="bold">Upcoming Appointments</h2>
                <div className="row">
                    ...
                    <div className="modal__dialog widget client-management-booking-card">
                      ...
                      <div className="margin-bottom-1 padding-left__t-1 padding-right__t-1">
                        <div className="record-grid record-grid--forms column-m-12">
                          ...
                          <div className="column--flex row--direction-column row--end">
                            <p>
                              As this booking is within 48 hours, please contact
                              the practitioner directly if you need to
                              reschedule.
                            </p>
                            {/* <div className="row--gap column--flex">
                              <button
                                className="button button--flat button--small button--rose button--fullwidth"
                                type="button"
                              >
                                Cancel
                              </button>
                ...
                <article>
                  <div className="fresnel-container fresnel-greaterThanOrEqual-md">
                    {appointments.length > 0 && (
                      <div className="data-header client-booking-list__header">
                        <div>
                          <span>Date</span>
                        </div>
                        <div>
                        ...
                        <div>
                          <span>Practitioner and Clinic</span>
                        </div>
                  ...
                  <div className="client-booking-wrapper">
                    {loading ? (
                      <div className="text-center">
                        <img
                          src="/static/img/icons/loading.svg"
                          alt="loading icon"
                          width={24}
                          height={24}
                        />
