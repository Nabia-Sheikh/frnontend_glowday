    ...
    <>
      {showOnMobile && (
        <div className="appear-on-scroll">
          <div
            className="search__navigation animation padding-top-1 padding-bottom__l-1  search__navigation--gray"
                                    ...
                                    {filteredTreatments.map((treatment) => (
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          />
                                          <label
                                            htmlFor={treatment.categoryName}
                                          >
                                            {treatment.categoryName}
                                          </label>
                                        </div>
      ...
      {isMobile ? (
        !showOnMobile && (
          <div
            className="search__navigation animation padding-top-1 padding-bottom__l-1  search__navigation--gold"
            data-testid="sticky-search"
          >
            <div className="container column--relative">
              <div className="fresnel-container fresnel-lessThan-md">
